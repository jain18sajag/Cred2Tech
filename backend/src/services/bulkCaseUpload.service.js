...
const resolveBulkFinancials = (row) => {
  ...
  const gstSales = parseNum(row['GST Average Monthly Sales'], 0) || parseNum(row['GST Turnover FY Latest'], 0) / 12 || parseNum(row['Last 12 Month Sales As Per GSTR'], 0) / 12 || parseNum(row['Annual Sales As Per GSTR'], 0) / 12 || 0;
